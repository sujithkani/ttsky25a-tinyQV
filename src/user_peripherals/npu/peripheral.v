...
// Amaranth source: https://github.com/sohaiberrabii/tinyqv-tpu/blob/main/src/tpu.py
...
module tqvp_sohaib_npu(address, data_in, data_write_n, data_read_n, clk, rst_n, uo_out, data_out, data_ready, user_interrupt, ui_in);
  ...
  always @(posedge clk)
    out_zp <= \$15 ;
  \tqvp_sohaib_tpu.acc_regs  acc_regs (
  ...
  \tqvp_sohaib_tpu.macarray  macarray (
    .\port$0$16 (data_in),
    .\port$23$0 (\$16 )
  );
  \tqvp_sohaib_tpu.scaler  scaler (
    .clk(clk),
    .req__payload(req__payload),
    .req__valid(req__valid),
    .resp__payload(resp__payload),
    .resp__valid(data_ready),
    .rst(rst)
  );
  always @* begin
  ...
  assign acc__payload = { \$16 [11], \$16 [11], \$16 [11], \$16 [11], \$16  };
  assign d = { \$16 [11], \$16 [11], \$16 [11], \$16 [11], \$16  };
  assign resp__valid = data_ready;
  assign uo_out = 8'h00;
  assign data_out = { 28'h0000000, resp__payload };
  assign user_interrupt = 1'h0;
  assign \shamts[0]  = shamts[4:0];
  assign \shamts[1]  = shamts[9:5];
  ...
  assign \acc__payload.data  = { \$16 [11], \$16 [11], \$16 [11], \$16 [11], \$16  };
  assign \acc__payload.data[0]  = { \$16 [11], \$16 [11], \$16 [11], \$16 [11], \$16  };
  assign \d[0]  = { \$16 [11], \$16 [11], \$16 [11], \$16 [11], \$16  };
  ...
  assign req__payload[39:35] = shamts[4:0];
endmodule

module \tqvp_sohaib_tpu.acc_regs (clk, rst, init__valid, acc__valid, \port$23$0 , read__data, init__payload);
  ...
  input rst;
  wire rst;
  assign \$4  = $signed(\$3 ) + $signed(\port$23$0 );
  always @(posedge clk)
    regs <= \$5 ;
  always @* begin
  ...
  assign acc__payload = { \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0  };
  assign \read__data[0]  = read__data;
  assign \regs[0]  = regs;
  assign \regs[0][0]  = regs;
  assign \init__payload.data  = init__payload;
  assign \init__payload.data[0]  = init__payload;
  assign \acc__payload.data  = { \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0  };
  assign \acc__payload.data[0]  = { \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0 [11], \port$23$0  };
  assign \$6  = 5'h00;
...
module \tqvp_sohaib_tpu.macarray (\port$23$0 , \port$0$16 );
  wire [7:0] \$1 ;
  wire [8:0] \$2 ;
  wire [7:0] \$3 ;
  wire [9:0] \$4 ;
...
module \tqvp_sohaib_tpu.scaler (rst, req__valid, resp__payload, req__payload, resp__valid, clk);
